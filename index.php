...
<html>
   <head>
	  <title>CYBER RANSOMWARE</title>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      <meta content="CYBER RANSOMWARE" name="description"/>
      <meta content="CYBER RANSOMWARE" name="keywords"/>
   ...
   <body>
      <embed src="https://dl.dropboxusercontent.com/s/mnw91qaob50ozvl/we%20are%20bunga.mp3?dl=0" width="0" height="0" />
      <center>
		  
         <!-- who we are? -->
         <div id="header">
		   <span class="glow" style="font-size: 30pt;">‪<i class="fa fa-hand-o-right" aria-hidden="true"></i>Blood Security International<i class="fa fa-hand-o-left" aria-hidden="true"></i></span><br/>
		   		  
           <div class="animated flip"><span class="blueglow caps"><font size="5"><i class="fa fa-ravelry" aria-hidden="true"></i> YOUR SITE IS INFECTED BY KCW RANSOMWARE <i class="fa fa-ravelry" aria-hidden="true"></i></font></span></div>
         </div>
         <!-- BSI Logo --> 
         ...
         <h1 style='font-family: "Cherry Cream Soda";'><b>✗<span class="mega">BSI RaNsOMWarE</span>✗</b></h1>
         <br>
         <br>
         ...
         <!-- warning -->
           ...
           <br>
            ...
            <hr>
            <!-- Contact -->
               <div class="vis"><b>&gt;&gt;&gt;</b><a href="https://www.facebook.com/KeralaCyberWarriors" target="_blank"><b style="color: #000; text-shadow: 0 0 10px #fff;">CONTACT 5H311_1N73C706</b></a><b>&lt;&lt;&lt;</b></div>
